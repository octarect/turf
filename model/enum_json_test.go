...
func TestEnumString(t *testing.T) {
	tests := []struct {
		...
		{name: "weather light snow", got: WeatherLightSnow.String(), want: "light_snow"},
		{name: "weather snow", got: WeatherSnow.String(), want: "snow"},
...
func TestEnumMarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{name: "weather light snow", v: WeatherLightSnow, want: `"light_snow"`},
		{name: "weather snow", v: WeatherSnow, want: `"snow"`},
